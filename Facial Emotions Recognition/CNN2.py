# -*- coding: utf-8 -*-
"""
Created on Sat Oct 14 13:42:36 2017
...
class CNN(object):
    def __init__(self,convpool_layer_sizes, hidden_layer_sizes):
        ...
        #reg = regularization 
        #eps = epsilon
    def fit(self, X, Y, lr= 1e-4, mu=0.99, reg = 10e-4, decay=0.99999, eps = 10e-3, batch_sz=30,epochs=3, show_fig=True):
        lr = np.float32(lr)
        mu = np.float32(mu)
        reg = np.float32(reg)
...
def main():
    ...
    #print(X)
    model = CNN(convpool_layer_sizes=[(32,5,5),(64,5,5)], hidden_layer_sizes = [1024,512],)
